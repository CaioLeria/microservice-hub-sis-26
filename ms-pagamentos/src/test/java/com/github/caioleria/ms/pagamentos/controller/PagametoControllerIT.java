...
import com.github.caioleria.ms.pagamentos.tests.Factory;
...
@ActiveProfiles("test")
@Transactional
public class PagametoControllerIT {
@Autowired
private MockMvc mockMvc;
    ...
    void createPagamentoShouldReturn422WhenInvalid() throws Exception{
        ...
        Pagamentos pagamentoInvalido = Factory.createPagamentoSemId();
    ...
    @Test
    void updatePagamentoShouldReturn200WhenIdExist() throws Exception{
        pagamentos = Factory.createPagamento();
        PagamentoDto requestDto = new PagamentoDto(pagamentos);
        String jsonRequestBody = objectMapper.writeValueAsString(requestDto);
        ...
        mockMvc.perform(put("/pagamentos/{id}", existingId)
                ...
                .andExpect(jsonPath("$.nome").value(pagamentos.getNome()));
    }

    @Test
    void updatePagamentoShouldReturn422WhenIdExist() throws Exception{
        pagamentos = Factory.createPagamentoSemId();
        pagamentos.setValor(BigDecimal.valueOf(-32.05));
        pagamentos.setNome(null);
        pagamentos.setPedidoId(null);
        PagamentoDto requestDto =new PagamentoDto(pagamentos);
        String jsonRequestBody = objectMapper.writeValueAsString(requestDto);
    ...
    @Test
    void deletePagamentoShouldReturn204WhenIdExist() throws Exception{
